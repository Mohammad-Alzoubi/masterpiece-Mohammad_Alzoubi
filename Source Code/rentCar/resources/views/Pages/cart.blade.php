				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="rn-cart-total-form">
							...
							<div class="rn-cart-subtotal"><strong>Subtotal:</strong>
								<span>$1400.00</span>
							</div>
							<div class="rn-cart-discount"><strong>Discount:</strong>
								<span>$200.00</span>
							</div>
							...
							<div class="text-right">
								<input class="btn btn-main btn-lg btn-shadow" type="submit" value="Proceed to checkout">
							</div>
						</div>
						<!-- End Cart Total-->
