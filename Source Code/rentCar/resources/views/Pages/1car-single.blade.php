				...
				<div class="row">
					...
					<div class="col-lg-4">
						...
						<div class="rn-small-search-form">
							...
							<form action="https://demo.kitthemes.com/html/rentnow/car-single.html">
								<div class="rn-icon-input">
									<i class="fas fa-map-marker-alt"></i>
									{{-- <input type="text" placeholder="Pickup Location"> --}}
									<select class="pl-30">
										<option class="text-secondary" disabled selected>Pickup Location</option>
										<option class="text-secondary" value="AL">Alabama</option>
										<option class="text-secondary" value="AK">Alaska</option>
										<option class="text-secondary" value="AS">American Samoa</option>
										<option class="text-secondary" value="AZ">Arizona</option>
										<option class="text-secondary" value="AR">Arkansas</option>
										<option class="text-secondary" value="CA">California</option>
										<option class="text-secondary" value="CO">Colorado</option>
										<option class="text-secondary" value="CT">Connecticut</option>
										<option class="text-secondary" value="DE">Delaware</option>
									</select>
								</div>
								<div class="rn-icon-input">
									<i class="fas fa-map-marker-alt"></i>
