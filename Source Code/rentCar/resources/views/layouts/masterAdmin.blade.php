    ...
    <div class="dashboard-main-wrapper">
      ...
      <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
          <span style="background-color: #0E0C28; width: 264px;"> <a style="color: #FFF" class="navbar-brand" href="{{asset('/admin')}}"><span style="color: #42DB0C">RENT</span>NOW</a> </span>
          <button
          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('admin/dashboard')}}"><i class="fab fa-pagelines"></i>Dashboard</a>
                </li>
                <li class="nav-item ">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('/admin/brand')}}"><i class="fas fa-fw fa-chart-pie"></i>Manage
                    Brand </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('/admin/vehicles')}}"><i class="fas fa-car"></i>Manage vehicles
                  </a>
                  
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('/admin/manage-bookings')}}"><i class="fas fa-fw fa-file"></i>Manage Bookings
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('/admin/contact')}}"><i class="fas fa-envelope"></i>Message Contact us
                  </a>
                </li>
              </ul>
            </div>
